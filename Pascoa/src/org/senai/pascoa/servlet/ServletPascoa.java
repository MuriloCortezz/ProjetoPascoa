...
public class ServletPascoa extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		String concluir = request.getParameter("concluir");
		...
		if (concluir == null) {
			...
			String listaOpcaoOvos[] = { "chocolate-350g", "chocolate-250g", "chocolate-500g", "coco-250g", "coco-350g",
					"coco-500g", "Maracuja-250g", "Maracuja-350g", "Maracuja-350g", "Maracuja-500g", "Mousse-250g",
					"Mousse-350g", "Mousse-500g", "Pmel-250g", "Pmel-350g", "Pmel-500g" };
			...
			if(obj.concluir(Integer.parseInt(concluir))) {
				saida.print("ok");
			}
